...
call ensure_concept(@concept_id, '7e67abb5-e42f-11e5-8c3e-08002715d519', 'All_Tests_and_Panels','A_T_and_P', 'N/A', 'ConvSet', true);
...
call ensure_concept_set_members(@lab_order_concept_id, @serum_concept_id, 1);
...
call ensure_concept_set_members(@lab_order_concept_id, @blood_concept_id, 2);
